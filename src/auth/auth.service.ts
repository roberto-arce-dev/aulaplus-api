...
import { ProfesorProfileService } from '../profesor-profile/profesor-profile.service';
...
export class AuthService implements OnModuleInit {
  constructor(
    ...
    private profesorProfileService: ProfesorProfileService,
  ) {}
    ...
    try {
      ...
      case Role.ESTUDIANTE:
        await this.estudianteProfileService.create(userId, {
          ...
          seccion: registerDto.seccion,
          apoderado: registerDto.apoderado,
        });
        break;
      case Role.PROFESOR:
        await this.profesorProfileService.create(userId, {
          nombreCompleto: registerDto.nombre,
          telefono: registerDto.telefono,
          especialidad: registerDto.especialidad,
          grados: registerDto.grados,
        });
        break;
      }
